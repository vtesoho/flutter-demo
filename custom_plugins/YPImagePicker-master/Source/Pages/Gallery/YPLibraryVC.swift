...
//        multipleSelectionButtonTapped()
        ...
        v.assetViewContainer.translatesAutoresizingMaskIntoConstraints = false
//        v.collectionView.deleteItems(at: [IndexPath(row: 0, section: 0)])
        
//        v.assetViewContainer.frame = CGRect(x: 0.0, y: 0.0, width: 414.0, height: 414.0)
    }
    ...
    public override func loadView() {
        ...
        v.frame = CGRect(x: 0.0, y: 0.0, width: UIScreen.main.bounds.size.width, height:  UIScreen.main.bounds.size.height)
        view = v
    }
...
//        v.assetViewContainer.addConstraint(item: v.assetViewContainer, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.equal, toItem: v.assetViewContainer, attribute: NSLayoutConstraint.Attribute.top, multiplier: 0.5, constant: 50)
//        v.assetZoomableView.addConstraint(item: v.assetZoomableView, attribute: NSLayoutConstraint.Attribute.top, relatedBy: NSLayoutConstraint.Relation.equal, toItem: v.assetZoomableView, attribute: NSLayoutConstraint.Attribute.top, multiplier: 0.5, constant: 50)
//        let width:NSLayoutConstraint = NSLayoutConstraint(item: v.collectionView, attribute:  NSLayoutConstraint.Attribute.width, relatedBy:NSLayoutConstraint.Relation.equal, toItem:nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier:0.0, constant:300)
//        v.collectionView.addConstraint(width)
//        
//    
////        v.collectionView.addConstraint(width)
//        v.assetViewContainer.addConstraint(widtha)
//        v.collectionView
...
//        v.collectionView.deleteItems(at: <#T##[IndexPath]#>)
        checkLimit()
...
//        v.collectionView.frame = CGRect(x: 0.0, y: 200.0, width: 414, height: 500)
