...
class YPAssetViewContainer: UIView {
    ...
    public let ratioButton = UIButton()
    ...
    override func awakeFromNib() {
        ...
        //vs
//        grid.frame = frame
//        grid.frame = CGRect(x: 0, y: 0, width: 100, height: 100)
        clipsToBounds = true
...
//        curtain.frame = CGRect(x: 100, y: 100, width: 100, height: 100)
        curtain.alpha = 0
...
//        ratioButton-90-|
//        ratioButton.setImage(YPConfig.icons.multipleSelectionOffIcon, for: .normal)
//        ratioButton.Bottom == zoomableView!.Bottom - 15
//
...
//        print("newFrame",newFrame)
        ...
        grid.frame = frame.intersection(CGRect(x: 0, y: 0, width: zoomableView.frame.width, height: zoomableView.frame.width))
        grid.layoutIfNeeded()
